...
def main():
    ...
    parser.add_argument("--collections", action="store_true", help="Run only collection tests")
    ...
    parser.add_argument("--functions", action="store_true", help="Run only function tests")
    ...
    parser.add_argument("--args", nargs=argparse.REMAINDER, help="Additional pytest arguments")
