...
from mosaia import (
    BaseCollection, Agents, Apps, Users, Organizations, OrgUsers,
    Tools, Clients, Models, AppBots, AgentGroups
)
...
class TestBaseCollection:
    ...
    def setup_method(self):
        ...
        with patch('mosaia.collections.base_collection.ConfigurationManager') as mock_cm:
...
class TestOrganizations:
    ...
    def test_should_initialize_with_correct_uri_and_model(self):
        ...
        with patch('mosaia.collections.organizations.BaseCollection.__init__') as mock_init:
            ...
            assert args[1].__name__ == 'Organization'  # Model class should be Organization
...
class TestAgentGroups:
    ...
    def test_should_initialize_with_correct_uri_and_model(self):
        ...
        with patch('mosaia.collections.agent_groups.BaseCollection.__init__') as mock_init:
    ...
    def test_should_initialize_with_custom_uri(self):
        ...
        with patch('mosaia.collections.agent_groups.BaseCollection.__init__') as mock_init:
            ...
            # The arguments are: (uri, model_class) - self is not included in args
            assert len(args) == 2
            assert args[0] == '/custom/agent-group'  # URI should be '/custom/agent-group'
            assert args[1].__name__ == 'AgentGroup'  # Model class should be AgentGroup
