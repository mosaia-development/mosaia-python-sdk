...
from mosaia import (
    MosaiaConfig, UserInterface, OrganizationInterface, AppInterface,
    AgentInterface, ToolInterface, QueryParams, APIResponse, BatchAPIResponse,
    ErrorResponse, PagingInterface, SessionInterface, OAuthConfig,
    OAuthTokenResponse, OAuthErrorResponse, ChatMessage, ChatCompletionRequest,
    ChatCompletionResponse, AuthType, GrantType
)
...
class TestToolInterface:
    ...
    def test_should_support_all_tool_properties(self):
        ...
        assert tool.tool_schema == '{"type": "object", "properties": {"location": {"type": "string"}}}'
