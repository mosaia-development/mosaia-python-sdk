...
from mosaia import MosaiaClient, ConfigurationManager, MosaiaConfig, SessionInterface
...
class TestMosaiaClient:
    ...
    def test_api_url_setter_should_update_api_url(self):
        ...
        with patch('mosaia.client.ConfigurationManager') as mock_config_manager:
            ...
            mock_instance.update_config.assert_called_with({'api_url': 'https://new-api.mosaia.ai'})
    ...
    def test_client_id_setter_should_update_client_id(self):
        ...
        with patch('mosaia.client.ConfigurationManager') as mock_config_manager:
            ...
            mock_instance.update_config.assert_called_with({'client_id': 'new-client-id'})
    ...
    def test_client_secret_setter_should_update_client_secret(self):
        ...
        with patch('mosaia.client.ConfigurationManager') as mock_config_manager:
            ...
            mock_instance.update_config.assert_called_with({'client_secret': 'new-client-secret'})
