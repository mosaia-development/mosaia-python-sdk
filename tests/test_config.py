...
from mosaia import ConfigurationManager, DEFAULT_CONFIG, MosaiaConfig, SessionInterface
...
class TestConfigurationManager:
    ...
    def test_initialize_should_initialize_with_default_values_when_no_config_provided(self):
