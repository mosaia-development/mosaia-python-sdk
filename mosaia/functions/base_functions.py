...
class BaseFunctions(ABC, Generic[T, GetPayload, CreatePayload]):
    ...
    async def create(self, entity: T, params: Optional[Dict[str, Any]] = None) -> CreatePayload:
        """
        Create a new entity.
    ...
    async def update(self, id: str, entity: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> CreatePayload:
        """
