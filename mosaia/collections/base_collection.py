...
from typing import Any, Dict, Optional, TypeVar, Generic, Union, List, Type
import urllib.parse

from ..config import ConfigurationManager
from ..types import MosaiaConfig, QueryParams, BatchAPIResponse, PagingInterface
...
class BaseCollection(ABC, Generic[T, M, GetPayload, CreatePayload]):
    ...
    async def get(self, params: Optional[Dict[str, Any]] = None, id: Optional[str] = None) -> Union[BatchAPIResponse, M, None]:
        """
